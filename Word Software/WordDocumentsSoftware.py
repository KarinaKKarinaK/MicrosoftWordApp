...
class BSWord(QMainWindow):
    def __init__(self):
        ...
        self.showMaximized()
        self.setWindowTitle('Word Document Software')
    ...
    def create_tool_bar(self):
        ...
        undo_action = QAction(QIcon(r'Word Software\undo.png'), 'undo', self)
        undo_action.triggered.connect(self.editor.undo)
        tool_bar.addAction(undo_action)

        redo_action = QAction(QIcon(r'Word Software\redo.png'), 'redo', self)
        ...
        cut_action = QAction(QIcon(r'Word Software\cut.png'), 'cut', self)
        cut_action.triggered.connect(self.editor.cut)
        tool_bar.addAction(cut_action)

        copy_action = QAction(QIcon(r'Word Software\copy.png'), 'copy', self)
        copy_action.triggered.connect(self.editor.copy)
        tool_bar.addAction(copy_action)

        paste_action = QAction(QIcon(r'Word Software\paste.png'), 'paste', self)
    ...
    def save_as_pdf(self):
        file_path, _ = QFileDialog.getSavedFilename(self, 'Export PDF', None, 'PDF Files (*.pdf)')
